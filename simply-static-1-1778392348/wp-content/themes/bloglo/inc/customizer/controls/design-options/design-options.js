(function ($) {
  ...
  wp.customize.controlConstructor["bloglo-design-options"] =
    wp.customize.Control.extend({
      ready: function () {
        ...
        // Range controls.
        control.container.find(".bloglo-range-wrapper").each(function () {
          var $this = $(this);
        ...
        control.container.on("change", ".bloglo-select-wrapper", function () {
          control.update_value();
        });
        ...
        // Linked button
        control.container.on("click", ".bloglo-spacing-linked", function () {
          // Set up variables
          var $this = $(this);
        ...
        // Unlinked button
        control.container.on("click", ".bloglo-spacing-unlinked", function () {
          // Set up variables
          var $this = $(this);
